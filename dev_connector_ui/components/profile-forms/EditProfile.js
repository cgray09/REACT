...
const EditProfile = ({ profile: { profile, loading }, createProfile, getCurrentProfile, history }) => {
    // This useState hook is used to define our state in a function component since
    // functional components dont have constructors 
    // formData is the state
    // setFormData is the function to change the state
    ...
    // So we can write in the text fields on profile page
