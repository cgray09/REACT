...
class Messages extends React.Component {
  ...
  addTypingListeners = channelId => {
    ...
    // disconnect from typingRef if logged in user logs out
  ...
  render() {
    ...
    // <div ref={node => (this.messagesEnd = node)} /> - will scroll to the 
    // bottum of the pages section
