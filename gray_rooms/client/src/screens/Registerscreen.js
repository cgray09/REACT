...
export default function Registerscreen() {
  ...
  return (
    <div className='register reg-container'>
      <div className="row justify-content-center mt-5">
        <div className="col-md-5 mt-5 text-left shadow-lg p-3 mb-5 bg-white rounded">
          ...
          <div>
            ...
            />
            <button disabled={!name || !email || !password || !cpassword} onClick={register} className="btn btn-primary rounded-pill mt-3 mb-3">REGISTER</button>
            <br/>
