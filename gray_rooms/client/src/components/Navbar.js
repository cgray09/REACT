    ...
    <div>
      <nav class="navbar navbar-expand-lg">
        {localStorage.getItem('currentUser') ? (
          <a class="navbar-brand nav-style" href="/home">
            GrayRooms
          </a>
        ) : (
          <a class="navbar-brand nav-style" href="/">
            GrayRooms
          </a>
        )}
        <button
          ...
          {localStorage.getItem('currentUser') ? (
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                ...
                <a className="a-style" href="#" onClick={logout}>Logout</a>
              </div>
            </div>
          </div>
          ) : (
            ...
            <li class="nav-item active">
              <a class="nav-link c" href="/register">
                Register
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link c" href="/login">
                Login
              </a>
            </li>
            </>
